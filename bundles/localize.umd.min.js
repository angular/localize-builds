...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function l(e,r){try{return function l(e,r,s){var c=function u(e,r){for(var l={},s=function c(e,t){var r=a(e,t),l=r.text,s=r.block;if(void 0===s)return{text:l,meaning:void 0,description:void 0,id:void 0};var c=i(s.split(o,2),2),u=c[1],f=i(c[0].split(n,2),2),d=f[0],p=f[1];return void 0===p&&(p=d,d=void 0),""===p&&(p=void 0),{text:l,meaning:d,description:p,id:u}}(e[0],e.raw[0]),u=s.text,f=1;f<e.length;f++){var d=a(e[f],e.raw[f]),p=d.block,g=void 0===p?"ph_"+f:p;u+="{$"+g+"}"+d.text,void 0!==r&&(l[g]=r[f-1])}return{messageId:s.id||t.computeMsgId(u,s.meaning||""),substitutions:l,messageString:u}}(r,s),f=e[c.messageId];if(void 0!==f)return[f.messageParts,f.placeholderNames.map(function(e){return c.substitutions[e]})];throw new Error('No translation found for "'+c.messageId+'" ("'+c.messageString+'").')}($localize.TRANSLATIONS,e,r)}catch(t){return console.warn(t.message),[e,r]}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
