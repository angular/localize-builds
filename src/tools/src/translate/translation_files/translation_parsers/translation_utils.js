(function (factory) {
    ...
    function canParseXml(filePath, contents, rootNodeName, attributes) {
        ...
        try {
            for (var _b = (0, tslib_1.__values)(Object.keys(attributes)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    function addErrorsToBundle(bundle, errors) {
        var e_2, _a;
        try {
            for (var errors_1 = (0, tslib_1.__values)(errors), errors_1_1 = errors_1.next(); !errors_1_1.done; errors_1_1 = errors_1.next()) {
