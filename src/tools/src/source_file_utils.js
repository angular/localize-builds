(function (factory) {
    ...
    function unwrapMessagePartsFromLocalizeCall(call, fs) {
        ...
        if (cooked.isLogicalExpression() && cooked.node.operator === '||' &&
            ...
            if (right.isAssignmentExpression()) {
                ...
                if (expressions.length > 2) {
                    ...
                    var _a = (0, tslib_1.__read)(expressions, 2), first = _a[0], second = _a[1];
        ...
        var _b = (0, tslib_1.__read)(unwrapStringLiteralArray(cooked, fs), 1), cookedStrings = _b[0];
        var _c = (0, tslib_1.__read)(unwrapStringLiteralArray(raw, fs), 2), rawStrings = _c[0], rawLocations = _c[1];
        return [(0, localize_1.ɵmakeTemplateObject)(cookedStrings, rawStrings), rawLocations];
    }
    ...
    function unwrapMessagePartsFromTemplateLiteral(elements, fs) {
        ...
        return [(0, localize_1.ɵmakeTemplateObject)(cooked, raw), locations];
    }
    ...
    function getReturnedExpression(fn) {
        ...
        try {
            for (var bodyStatements_1 = (0, tslib_1.__values)(bodyStatements), bodyStatements_1_1 = bodyStatements_1.next(); !bodyStatements_1_1.done; bodyStatements_1_1 = bodyStatements_1.next()) {
    ...
    function translate(diagnostics, translations, messageParts, substitutions, missingTranslation) {
        try {
            ...
            if ((0, localize_1.ɵisMissingTranslationError)(e)) {
                diagnostics.add(missingTranslation, e.message);
                // Return the parsed message because this will have the meta blocks stripped
                return [
                    (0, localize_1.ɵmakeTemplateObject)(e.parsedMessage.messageParts, e.parsedMessage.messageParts),
                    substitutions
                ];
            }
            else {
    ...
    var BabelParseError = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(BabelParseError, _super);
